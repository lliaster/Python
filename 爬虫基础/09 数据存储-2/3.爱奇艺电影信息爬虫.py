...
class AiQiYi:
    def __init__(self):
        self.client = pymongo.MongoClient('mongodb://192.168.1.14:27017')
    ...
    def save_movie_info(self, item):    # 保存数据
        try:
